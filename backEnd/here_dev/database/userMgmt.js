...
exports.register = function(userInfo, callback) {
	...
	sqlArray.push(
		'insert into user_base_info (user_id, user_phone, user_name, user_password, user_facethumbnail, user_face_image, user_gender, user_certificated_process, certificate_id, user_fans_count, user_follow_count, user_birth_day) values (?,?,?,?,?,?,?,?,?,?,?,?,?)'
	);
