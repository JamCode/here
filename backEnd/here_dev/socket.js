...
var redisClient = redis.createClient({auth_pass:global_config.redis_pass.pass, port:global_config.redis_pass.port});
var fs = require('fs');
...
function startSocketServer () {
    ...
    if(process.env.ENV === 'pro'){
        options = {
    	  key: fs.readFileSync(__dirname + '/key/server_pro.key'),
    	  cert: fs.readFileSync(__dirname + '/key/server_pro.crt')
    	};
    }
