...
exports.copyfile = function copyfile(fromfile, tofile, callback) {
    ...
    exports.mkdir(path.dirname(tofile),
    function(err) {
        if (err) {
            return callback(err);
        ...
        ws.once('error', onerr);
        // if file not open, these is only error event will be emit.
        rs.once('error', onerr);
        ws.on('close',
        function() {
...
function daliyRprt(dirPath, fromFile) {
    ...
    exports.copyfile(dirPath + fromFile, toFile,
    function(err) {
        if (err) {
            throw err;
...
//var dirPath = 'C:\\Users\\Micheal\\AppData\\Roaming\\npm\\node_modules\\';
