...
if(cluster.isMaster){
 ...
 //  	});
	...
	fs.writeFileSync(pidfile, process.pid, {flag:'w'});
...
function startHTTPServer(port){
	...
	var accessLogStream = fs.createWriteStream(__dirname + '/access.log', {flags: 'a', encoding:'utf-8'});
	//accessLogStream.setEncoding('utf-8');
	global.app.use(morgan('dev', {stream: accessLogStream})); 
