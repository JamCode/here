...
- (void)getFollowList:(NSInteger)timestamp handleAction:(SEL)handleAction
{
    ...
    NSDictionary* message = [[NSDictionary alloc] initWithObjects:@[myInfo.userID, [[NSNumber alloc] initWithInteger:timestamp],  @"/getfollowUser"] forKeys:@[@"user_id", @"follow_timestamp", @"childpath"]];
